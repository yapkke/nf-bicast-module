...
/* Sequence number wrap-around params */
#define NF_MOBILITY_TCP_SEQ_NUM_MIN 0
#define NF_MOBILITY_TCP_SEQ_NUM_MAX 0xffffffff
#define NF_MOBILITY_TCP_SEQ_NUM_WRAP_THRESHOLD 2147483647
#define NF_MOBILITY_IP_NUM_MIN 0
#define NF_MOBILITY_IP_NUM_MAX 65535
#define NF_MOBILITY_IP_NUM_WRAP_THRESHOLD 32768
